    ...
    public class GH_RFEM : GH_Goo<IGrassRFEM>
    {
        ...
        public override bool Write(GH_IO.Serialization.GH_IWriter writer)
        {
            ...
            try
            {
                ...
                writer.SetString("Object_json", json);
            }
            catch (Exception ex)
            {
                throw ex; // Consider handling the exception more gracefully
            }
            return base.Write(writer);
        }
        ...
        public override bool Read(GH_IO.Serialization.GH_IReader reader)
        {
            ...
            string s = "";
            if (reader.TryGetString("Object_json", ref s))
            {
                try
                {
                    Value = JsonConvert.DeserializeObject<IGrassRFEM>(s);
                }
                catch (Exception ex)
                {
                    throw ex; // Consider handling the exception more gracefully
