...
{
    public class Component_RFFreeLineLoad_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFFreeLineLoad_GUI()
          : base("RF Free Line Load", "RFLLoad", "Assembles and Disassembles RFFLineLoad objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rflineload", "load", "line", "free" };
        ...
        {
            subcomponents_.Add(new SubComponent_RFFreeLineLoad_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFFreeLineLoad_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_FreeLineLoad;                
            }
        }
        ...
        {
            get { return new Guid("51463847-b4c4-4689-8b0b-0bdf6f65b033"); }
        }
    }
}
