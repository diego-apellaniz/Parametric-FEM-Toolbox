...
{
    public class Component_RFNodalRelease_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFNodalRelease_GUI()
          : base("RF Nodal Release", "RFNodalRelease", "Assembles and Disassembles RFNodalRelease objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }
        ...
        {
            subcomponents_.Add(new SubComponent_RFNodalRelease_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFNodalRelease_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_NodalRelease;                
            }
        }
        ...
        {
            get { return new Guid("699d3fe4-b24a-490a-b335-3e5adfb06c21"); }
        }
    }
}
