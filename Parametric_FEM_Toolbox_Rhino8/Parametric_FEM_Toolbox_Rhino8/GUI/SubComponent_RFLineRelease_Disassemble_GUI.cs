...
{
    public class SubComponent_RFLineRelease_Disassemble_GUI : SubComponent
    {
        ...
        protected void Setup(EvaluationUnit unit)
        {
            ...
            unit.RegisterOutputParam(new Param_Number(), "Rotation", "Rot", "Rotation [°].");
        ...
        public override void SolveInstance(IGH_DataAccess DA, out string msg, out GH_RuntimeMessageLevel level)
        {
            ...
            DA.SetData(9, rfNodalRelease.Rotation*180/Math.PI);
            DA.SetData(10, rfNodalRelease.Comment);
        }
    }
}
