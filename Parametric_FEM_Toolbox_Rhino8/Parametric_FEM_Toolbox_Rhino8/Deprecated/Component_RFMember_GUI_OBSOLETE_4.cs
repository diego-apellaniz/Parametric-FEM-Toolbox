...
{
    public class Component_RFMember_GUI_OBSOLETE_4 : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFMember_GUI_OBSOLETE_4()
        ...
        {
            subcomponents_.Add(new SubComponent_RFMember_Assemble_GUI_OBSOLETE_2());
            subcomponents_.Add(new SubComponent_RFMember_Disassemble_GUI_OBSOLETE_3());
