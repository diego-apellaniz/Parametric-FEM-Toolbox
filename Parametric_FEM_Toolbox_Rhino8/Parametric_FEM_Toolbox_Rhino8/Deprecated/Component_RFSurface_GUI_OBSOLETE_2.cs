...
{
    public class Component_RFSurface_GUI_OBSOLETE_2 : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFSurface_GUI_OBSOLETE_2()
        ...
        {
            subcomponents_.Add(new SubComponent_RFSurface_Assemble_GUI_OBSOLETE_2());
            subcomponents_.Add(new SubComponent_RFSurface_Disassemble_GUI_OBSOLETE());
