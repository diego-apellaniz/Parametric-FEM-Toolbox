...
{
    public class Component_RFNodalSupport_GUI_OBSOLETE : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFNodalSupport_GUI_OBSOLETE()
        ...
        {
            subcomponents_.Add(new SubComponent_RFNodalSupport_Assemble_GUI_OBSOLETE());
            subcomponents_.Add(new SubComponent_RFNodalSupport_Disassemble_GUI_OBSOLETE());
