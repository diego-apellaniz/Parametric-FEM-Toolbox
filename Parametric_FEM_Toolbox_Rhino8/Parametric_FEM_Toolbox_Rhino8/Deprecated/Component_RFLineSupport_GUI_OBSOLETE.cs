...
{
    public class Component_RFLineSupport_GUI_OBSOLETE : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLineSupport_GUI_OBSOLETE()
        ...
        {
            subcomponents_.Add(new SubComponent_RFLineSupport_Assemble_GUI_OBSOLETE());
            subcomponents_.Add(new SubComponent_RFLineSupport_Disassemble_GUI_OBSOLETE());
