...
{
    public class Component_RFLineReleaseType_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLineReleaseType_GUI()
          : base("RF Line Release Type", "RFLineReleaseType", "Assembles and Disassembles RFLineReleaseType objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] { "rf", "rflinereleasetype", };
        ...
        {
            subcomponents_.Add(new SubComponent_RFLineReleaseType_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFLineReleaseType_Disassemble_GUI());
        ...
        {
            get { return new Guid("7abb5366-c3f4-42c4-ba31-7cb9d90b47a6"); }
        }
    }
}
