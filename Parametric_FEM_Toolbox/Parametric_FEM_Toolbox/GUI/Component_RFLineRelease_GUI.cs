...
{
    public class Component_RFLineRelease_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFLineRelease_GUI()
        ...
        {
            subcomponents_.Add(new SubComponent_RFLineRelease_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFLineRelease_Disassemble_GUI());
        ...
        {
            get { return new Guid("7e9b98ff-c28d-4f75-bfdc-63cad40bb51b"); }
        }
    }
}
