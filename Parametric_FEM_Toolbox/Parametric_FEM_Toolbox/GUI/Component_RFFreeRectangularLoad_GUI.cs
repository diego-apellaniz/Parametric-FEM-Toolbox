...
{
    public class Component_RFFreeRectangularLoad_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFFreeRectangularLoad_GUI()
          : base("RF Free Rectangular Load", "RFRectLoad", "Assembles and Disassembles RFFreeRectangularLoad objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] { "rf", "rfrectload", "load", "rectangular", "free" };
        ...
        {
            subcomponents_.Add(new SubComponent_RFFreeRectangularLoad_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFFreeRectangularLoad_Disassemble_GUI());
        ...
        {
            get { return new Guid("aa9ed8f4-c045-4ed1-a873-4a6ed42e7246"); }
        }
    }
}
