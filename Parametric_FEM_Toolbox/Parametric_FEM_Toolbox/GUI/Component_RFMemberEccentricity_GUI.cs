...
{
    public class Component_RFMemberEccentricity_GUI : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFMemberEccentricity_GUI()
          : base("RF Member Eccentricity", "RFMemberEccentricity", "Assembles and Disassembles RFMemberEccentricity objects.", "B+G Toolbox", "RFEM")
        {
            this.Hidden = (true);
        }

        // Define Keywords to search for this Component more easily in Grasshopper
        public override IEnumerable<string> Keywords => new string[] {"rf", "rfmembereccentricity",};
        ...
        {
            subcomponents_.Add(new SubComponent_RFMemberEccentricity_Assemble_GUI());
            subcomponents_.Add(new SubComponent_RFMemberEccentricity_Disassemble_GUI());
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Assemble_MemberEccentricity;                
            }
        }
        ...
        {
            get { return new Guid("23ef700c-5610-47b2-86c8-cfd96925dc12"); }
        }
    }
}
