...
namespace Parametric_FEM_Toolbox.Deprecated{
    public class Component_RFMaterial_GUI_OBSOLETE_2 : GH_SwitcherComponent
    {
        ...
        /// </summary>
        public Component_RFMaterial_GUI_OBSOLETE_2()
        ...
        {
            subcomponents_.Add(new SubComponent_RFMaterial_Assemble_GUI_OBSOLETE());
            subcomponents_.Add(new SubComponent_RFMaterial_Disassemble_GUI_OBSOLETE());
