...
{
    [Serializable]
    public class RFResultCombo : IGrassRFEM
    {
          
        //Standard constructors
        public RFResultCombo()
        {
        }
        public RFResultCombo(ResultCombination load)
        {
        ...
        {
            return string.Format($"RFEM-ResultCombination;No:{No};" +
        ...
        public static implicit operator ResultCombination(RFResultCombo lcombo)
        {
            ResultCombination myLoadCombo = new ResultCombination
            {
            ...
            myLoadCombo.Loading.Type = LoadingType.ResultCombinationType;
            return myLoadCombo;
        }
