...
namespace RFEM_daq.GUI
{
    public class Component_OptimizeCS_GUI : GH_SwitcherComponent
    {
        ...
        {
            EvaluationUnit evaluationUnit = new EvaluationUnit("Optimize Cross Sections", "Optimize CroSec", "Performs a Cross Section Optimization with the EC3 Module.", RFEM_daq.Properties.Resources.icon_SetData);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return RFEM_daq.Properties.Resources.Disassemble_Surface;                
            }
        }
