...
namespace RFEM_daq.GUI
{
    public class Component_SetData_GUI_OBSOLETE_3 : GH_SwitcherComponent
    {
        ...
        {
            EvaluationUnit evaluationUnit = new EvaluationUnit("Set Data", "Set Data", "Sets Data from the RFEM Model.", RFEM_daq.Properties.Resources.icon_SetData);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return RFEM_daq.Properties.Resources.icon_SetData;                
            }
        }
